...
describe('RequestQslComponent', () => {
    ...
    it('should have <h6> with "Please fill in the form, if you are in my log book, a QSL card will be generated for download:"', async () => {
    ...
    it('should have <p> with "Please fill in the form, if you are in my log book, a QSL card will be generated for download:"', async () => {
        const bannerElement: HTMLElement = fixture.nativeElement;
