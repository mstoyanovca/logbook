...
describe('QsoService', () => {
  ...
  const qso = new QSO(4, date, time, 'LZ4MN', '10m', 'FM', '588', 'Mike', 'Sofia', 'Dipole');

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [NGXLogger, {provide: NGXLoggerHttpService, useClass: NGXLoggerHttpServiceMock}, LoggerConfig, QsoService],
