...
describe('TransceiverComponent', () => {
  ...
  it('should have <h5> with "80m Single Band Transceiver"', () => {
    const bannerElement: HTMLElement = fixture.nativeElement;
    const h5 = bannerElement.querySelector('h5');
    expect(h5.textContent.trim()).toEqual('80m Single Band Transceiver');
  });

  it('should have <p> with "A superheterodyne transceiver with single frequency conversion and 9MHz crystal IF filter:"', () => {
    const bannerElement: HTMLElement = fixture.nativeElement;
